...
-- 2a. Elimination avec NOT IN mais avec code services écrit en dur
SELECT * FROM Employes WHERE CodeServices NOT IN ('DIRGE', 'INFOR', 'RESHU');

-- 2b. la meme mais avec codeServices écrit en mou
SELECT 
	* 
FROM 
	Employes 
...
-- Qd requete1 est referencee à l'interieur de requete2 (qui elle-meme est dans requete1)
