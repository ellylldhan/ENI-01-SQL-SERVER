...
-- la date de payement d’une fiche est toujours, 
-- si elle est renseignée, postérieure à sa date de création.

-- La date de payement d’une fiche est renseignée 
-- si l’état est soldé et n’est pas renseignée 
