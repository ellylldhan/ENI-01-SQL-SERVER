...
(
    isbn    numeric(10)
        constraint pk_ouvrages primary key,
...
(
    numero    int
        constraint pk_membres primary key identity,
...
(
    ...
    membre int
        constraint fk_emprunts_membres references membres (numero),
...
(
    emprunt    int
        constraint fk_details_emprunts references emprunts (numero),
    numero     int,
    isbn       numeric(10),
    exemplaire int,
    rendule    date,
...
insert into ouvrages (isbn, titre, auteur, genre, editeur) VALUES (2746021285, 'HTML entraînez-vous pour maîtriser le code source', 'Luc Van Lancker', 'INF', 'ENI');
insert into ouvrages (isbn, titre, auteur, genre, editeur) VALUES (2746026090, ' Oracle 12c SQL, PL/SQL, SQL*Plus', 'J. Gabillaud', 'INF', 'ENI');
insert into ouvrages (isbn, titre, auteur, genre, editeur) VALUES (2266085816, 'Pantagruel', 'François RABELAIS', 'ROM', 'POCKET');
...
insert into ouvrages (isbn, titre, auteur, genre, editeur) VALUES (2070367177, 'Le curé de Tours', 'Honoré de Balzac', 'ROM', 'Gallimard');
insert into ouvrages (isbn, titre, auteur, genre, editeur) VALUES (2877065073, 'La gloire de mon père', 'Marcel Pagnol', 'ROM', 'Fallois');
...
insert into ouvrages (isbn, titre, auteur, genre, editeur) VALUES (2038704015, 'De la terre à la lune', 'Jules Verne', 'ROM', 'Larousse');
insert into ouvrages (isbn, titre, auteur, genre, editeur) VALUES (2409015867, 'Kotlin', 'Anthony Cosson', 'INF', 'ENI');
insert into ouvrages (isbn, titre, auteur, genre, editeur) VALUES (2409008153, 'JEE', 'Thierry Richard', 'INF', 'ENI');
...
insert into ouvrages (isbn, titre, auteur, genre, editeur) VALUES (2080720872, 'Boule de suif', 'Guy de Maupassant', 'REC', 'Flammarion');
...
Update emprunts
    set etat='RE'
    where   etat = 'EC'
        and numero not in (select emprunt from detailsemprunts where rendule is null);
